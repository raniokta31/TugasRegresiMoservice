...
WebUI.verifyElementVisible(findTestObject('Login/Tab_login'))

WebUI.click(findTestObject('Login/Tab_login'))

WebUI.verifyElementVisible(findTestObject('Login/TextBox_username'))

WebUI.setText(findTestObject('Login/TextBox_username'), '081219751795')

WebUI.verifyElementVisible(findTestObject('Login/TextBox_Password'))

WebUI.setText(findTestObject('Login/TextBox_Password'), 'Jakarta3')

WebUI.verifyElementVisible(findTestObject('Login/Button_masuk'))
...
WebUI.verifyElementVisible(findTestObject('Katalog_promo_motor/Button_ViewPromo2'))

WebUI.click(findTestObject('Katalog_promo_motor/Button_ViewPromo2'))

WebUI.takeScreenshot()

WebUI.verifyElementVisible(findTestObject('Katalog_promo_motor/Button_PilihBengkel'))

WebUI.click(findTestObject('Katalog_promo_motor/Button_PilihBengkel'))

WebUI.takeScreenshot()

WebUI.verifyElementVisible(findTestObject('Katalog_promo_motor/List_Bengkel'))

WebUI.click(findTestObject('Katalog_promo_motor/List_Bengkel'))
