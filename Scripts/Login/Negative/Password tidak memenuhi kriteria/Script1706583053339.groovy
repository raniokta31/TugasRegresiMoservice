...
'isi field dengan nomor telepon yang valid'
...
'isi field dengan password yang tidak memenuhi kriteria'
WebUI.setText(findTestObject('Login/textbox_password'), 'tes')
...
'label error no telp muncul'
WebUI.verifyElementVisible(findTestObject('Login/label_errorTelp'))

'label data error muncul'
WebUI.verifyElementVisible(findTestObject('Login/label_error'))

WebUI.comment('tidak bisa login dikarenakan password tidak memenuhi kriteria')
