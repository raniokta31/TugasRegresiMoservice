...
'label error password sudah muncul'
WebUI.verifyElementVisible(findTestObject('Login/label_errorPass'))

WebUI.comment('button masuk disabled dikarenakan field password belum diisi')
