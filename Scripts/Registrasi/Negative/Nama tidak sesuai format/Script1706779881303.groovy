...
WebUI.setText(findTestObject('Registrasi/textbox_nama'), 'Si manis10 @@!,.,.,')

WebUI.verifyElementVisible(findTestObject('Login/textbox_telepon'))

WebUI.setText(findTestObject('Login/textbox_telepon'), '0812080820202')
...
WebUI.comment('Kok tetep bisa ya walaupun formatnya salah?')
