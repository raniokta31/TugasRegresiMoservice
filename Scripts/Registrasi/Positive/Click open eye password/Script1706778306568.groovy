...
WebUI.verifyElementVisible(findTestObject('Registrasi/button_eye'))

WebUI.click(findTestObject('Registrasi/button_eye'))
...
WebUI.verifyElementVisible(findTestObject('Registrasi/button_eye2'))

WebUI.click(findTestObject('Registrasi/button_eye2'))
